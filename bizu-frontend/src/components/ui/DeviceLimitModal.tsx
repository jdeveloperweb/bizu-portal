...
export function DeviceLimitModal({
    ...
    const handleSendCode = async (selectedType: "EMAIL" | "WHATSAPP") => {
        ...
        try {
            ...
            if (res.ok) {
                toast.success(`Código enviado para o seu ${selectedType === "EMAIL" ? "e-mail" : "WhatsApp"}!`);
                setStep("CODE");
            } else {
                    ...
                    {step === "CHOICE" ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-amber-500 hover:bg-amber-600 disabled:bg-gray-700 disabled:text-gray-500 text-black font-bold rounded-xl transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2"
                            >
